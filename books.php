...
<body>
	<!--________________________________sidenav_____________________________________________________________-->
...
function closeNav() {
  ...
  document.body.style.backgroundColor = "white";
	...
	<!--________________________________________request book____________________________________________________-->
	<div class="srch">
		<form class="navbar-form" method="post" name="form1">
